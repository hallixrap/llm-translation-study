...
2. **Gemini 3 Pro** achieves the highest translation quality (COMET: 0.867), while **Gemini 3 Pro** leads in lexical overlap (BLEU: 38.2).
...
|-------|------|------|-----------|-------|
| Gemini 3 Pro | **38.2** | **63.6** | 0.839 | 0.867 |
| Claude Opus 4.5 | 35.8 | 62.1 | **0.853** | **0.864** |
| GPT-5.1 | 34.8 | 60.7 | 0.838 | 0.862 |
| Kimi K2 | 34.5 | 60.8 | 0.835 | 0.864 |
